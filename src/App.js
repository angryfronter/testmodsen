...
import { Routes, Route, Navigate, RouterProvider, Link, createBrowserRouter, createRoutesFromElements} from 'react-router-dom';
...
/*const router = createBrowserRouter(createRoutesFromElements(
    // сюда записываем что должно быть без routes
))*/
